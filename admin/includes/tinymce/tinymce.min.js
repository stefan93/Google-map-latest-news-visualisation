		...
		return function(a) {
			...
			function C(e, t, n, r) {
				function i(e, t, i) {
					...
					for (l = 0; l < s.length; l++) if ("attributes" === i ? U.getAttrib(e, s[l]) : T(e, s[l])) return t;
					return t
				}
				var o = f(t),
					a, s, l;
			...
			function z(t, n, r, i) {
				...
				function d(e, t) {
					...
					else if (e = c($.getStart()), !e) for (; e = U.get(g);) d(e, !1)
				}
				function p() {
					var e, t, i, a, s, l, d;
				...
				function h() {
					...
					if (d) if (c) l = $.getBookmark(), e.collapse(!0), e = L(e, f(n), !0), e = q.split(e), y(n, r, e), $.moveToBookmark(l);
					else {
