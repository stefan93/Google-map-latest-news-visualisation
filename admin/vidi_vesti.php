...
$novine=sanitize($_GET["n"]);
$nov=new Novina($novine);
?>
...
?>
<div class="container">
    <a  href="<?php echo $nov->link_novina(); ?>"><span class="label label-info"><?php echo $nov->naziv(); ?></span></a>
    <?php
    $rez=$nov->prikazi_vesti_objavljene();
    foreach($rez as $r) {
        $id=$r["id_vesti"];
        $v=new Vest($id);
        ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        <div class="btn btn-default" triger="promeni_kategoriju" role="stara" id="<?php echo $v->id_vesti; ?>">
                            Promeni kategoriju
                        </div>
