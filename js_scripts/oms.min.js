...
(function() {
  ...
  this['OverlappingMarkerSpiderfier'] = (function() {
    ...
    p['markersWontHide'] = true;

    p['markersWontMove'] = true;
    ...
    p['markersNearAnyOtherMarker'] = function() {
      ...
      for (i1 = _j = 0, _len1 = _ref2.length; _j < _len1; i1 = ++_j) {
        ...
        for (i2 = _k = 0, _len2 = _ref3.length; _k < _len2; i2 = ++_k) {
          ...
          if ((this.ptDistanceSq(m1Data.pt, m2Data.pt) < pxSq) && (this.ptDistanceSq(m1Data.pt, m2Data.pt) > 30 )) {
